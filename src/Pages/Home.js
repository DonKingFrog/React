    ...
    return (
        <Fragment>
            <div className="page-home">
                <section id="hero">
                    <div className="main verticle-wrapper">
                        ...
                        <div className="actions">
                            <a href="/react/marketplace" id="button">Marketplace</a>
                            <a href="/react/about" id="redirect">Learn More</a>
                        </div>
                    </div>
                    ...
                    <div className="highlights horizontal-wrapper">
                        <div>
                            ...
                            <h1>Editor's Pick</h1>
                            <p>Donation Board is recommended by both experts and critiques.</p>
                        </div>
                ...
                <section id="previews">
                    <img src="/react/imgs/app-development-1.gif" alt="" />
                ...
                <section id="help">
                    <div className="support">
                        <h1>Need Help?</h1>
                        <div id="wrapper">
                            <a href="/react/contact" id="redirect">Contact Support</a>
                            <a href="/react/contact" id="redirect">Frequently Asked Questions</a>
                        </div>
                    </div>
                    ...
                    <div className="faq">
                        <button className="faqItem active" onClick={(event) => toggleFAQActive(event)}>
                            ...
                            <p>Yes! We value your feedback and suggestions. Visist our <a href="/react/discord">Join</a> to submit your ideas. Our team reviews all submissions and considers them for the future.</p>
                        ...
                        <button className="faqItem" onClick={(event) => toggleFAQActive(event)}>
                            ...
                            <p>You may join our <a href="/react/discord">Join</a> and ask a staff member or a fellow developer to assist you!</p>
                        ...
                        <button className="faqItem" onClick={(event) => toggleFAQActive(event)}>
                            ...
                            <p>To report a bug or issue, please visit our <a href="/react/discord">Join</a>. Find the Bug Report channel and write a detailed response about the issue you're having. Our team will investigate and address the problem as soon as possible.</p>
                ...
                <section id="community">
                    ...
                    <a className="hidden" id="button" href="/react/discord">Join Community Discord</a>
