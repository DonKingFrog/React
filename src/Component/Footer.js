        ...
        <footer>
            <div class="cards">
                ...
                <div class="redirect">
                    <div id="about">
                        <p>ABOUT</p>
                        <a href="/react/about">Our Story</a>
                        <a href="/react/blog">Blog</a>
                        <a href="/react/contact">Contact Us</a>
                    </div>

                    <div id="products">
                        <p>PRODUCTS</p>
                        <a href="/react/product/nexusdynamics">Nexus Dynamics</a>
                        <a href="/react/product/donationboard">Donation Board</a>
                        <a href="/react/product/axisindicator">Axis Indicator</a>
                        <a href="/react/marketplace">Marketplace</a>
                    </div>

                    <div id="about">
                        <p>RESOURCES</p>
                        <a href="/react/discord">Community</a>
                    </div>

                    <div id="support">
                        <p>SUPPORT</p>
                        <a href="/react/faq">FAQ</a>
                        <a href="/react/contact">Report a Problem</a>
                    </div>
                </div>
            </div>
            ...
            <div class="information">
                <div class="left">
                    <p id="rights">@2025 Dev Equip. All rights reserved.</p>
                </div>
                ...
                <div class="right">
                        <a href="https://github.com/Dev-Equip">
                        ...
                        <a href="https://www.youtube.com/@DevEquip">
