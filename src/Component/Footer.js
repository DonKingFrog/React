        ...
        <footer>
            <div class="cards">
                ...
                <div class="redirect">
                    ...
                    <div id="products">
                        <p>PRODUCTS</p>
                        <Link to="/product/nexusdynamics">Nexus Dynamics</Link>
                        <Link to="/product/donationboard">Donation Board</Link>
                        <Link to="/product/axisindicator">Axis Indicator</Link>
            ...
            <div class="information">
                ...
                <div class="right">
                        <Link to="https://github.com/Dev-Equip">
                        ...
                        <Link to="https://www.youtube.com/@DevEquip">
